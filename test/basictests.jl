function basicpolyhedrontests(lib::PolyhedraLibrary)
    ...
    @testset "Polyhedron cartesian product tests with $(typeof(lib))" begin
        pv1 = polyhedron(vrep([1 2; 3 4], [5 6]), lib)
        pv2 = polyhedron(vrep([5 6; 7 8], [9 1; 2 3]), lib)
        qv = pv1 * pv2
        generator_fulltest(vrep(qv), [1 2 5 6; 1 2 7 8; 3 4 5 6; 3 4 7 8], [5 6 0 0; 0 0 9 1; 0 0 2 3])
        ph1 = polyhedron(hrep([1 2; 3 4], [5, 6]), lib)
        ph2 = polyhedron(hrep([7 8; 9 1], [2, 3]), lib)
        qh = ph1 * ph2
        inequality_fulltest(hrep(qh), [1 2 0 0; 3 4 0 0; 0 0 7 8; 0 0 9 1], [5, 6, 2, 3], IntSet())
    end
end
