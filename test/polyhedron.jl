@testset "Dual Type" begin
    h = LPHRep(spzeros(Int, 2, 2), [1, 2], [3, 4], [4, 5], [6, 7])
    p = polyhedron(h)
    @test p isa Polyhedra.DefaultPolyhedron{Rational{BigInt}, LPHRep{Rational{BigInt}}, Polyhedra.Hull{Rational{BigInt}, Vector{Rational{BigInt}}, Int}}
