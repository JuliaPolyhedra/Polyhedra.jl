...
@testset "Show" begin
    ...
    @testset "Polyhedron without H-representation" begin
        @test replstr(p)        == "Polyhedron Polyhedra.SimplePolyhedron{Rational{BigInt},Polyhedra.Intersection{Rational{BigInt},Array{Rational{BigInt},1},Int64},Polyhedra.Hull{Rational{BigInt},Array{Rational{BigInt},1},Int64}}:\n3-element iterator of Array{Rational{BigInt},1}:\n Rational{BigInt}[1//1, -1//1]\n Rational{BigInt}[2//1, -2//1]\n Rational{BigInt}[3//1, -3//1],\n1-element iterator of Polyhedra.Ray{Rational{BigInt},Array{Rational{BigInt},1}}:\n Ray(Rational{BigInt}[1//1, 0//1])"
        @test replstr(p, false) == "Polyhedron Polyhedra.SimplePolyhedron{Rational{BigInt},Polyhedra.Intersection{Rational{BigInt},Array{Rational{BigInt},1},Int64},Polyhedra.Hull{Rational{BigInt},Array{Rational{BigInt},1},Int64}}:\n3-element iterator of Array{Rational{BigInt},1}:\n Rational{BigInt}[1//1, -1//1]\n Rational{BigInt}[2//1, -2//1]\n Rational{BigInt}[3//1, -3//1],\n1-element iterator of Polyhedra.Ray{Rational{BigInt},Array{Rational{BigInt},1}}:\n Ray(Rational{BigInt}[1//1, 0//1])"
        @test showstr(p) == "convexhull(Rational{BigInt}[1//1, -1//1], Rational{BigInt}[2//1, -2//1], Rational{BigInt}[3//1, -3//1]) + convexhull(Ray(Rational{BigInt}[1//1, 0//1]))"
    end
    h = hrep(p)
    @testset "V-Representation" begin
        @test replstr(v)        == "V-representation Polyhedra.Hull{$Int,Array{$Int,1}}:\n3-element iterator of Array{$Int,1}:\n [1, -1]\n [2, -2]\n [3, -3],\n1-element iterator of Polyhedra.Ray{$Int,Array{$Int,1}}:\n Ray([1, 0])"
        @test replstr(v, false) == "V-representation Polyhedra.Hull{$Int,Array{$Int,1}}:\n3-element iterator of Array{$Int,1}:\n [1, -1]\n [2, -2]\n [3, -3],\n1-element iterator of Polyhedra.Ray{$Int,Array{$Int,1}}:\n Ray([1, 0])"
        @test showstr(v) == "convexhull([1, -1], [2, -2], [3, -3]) + convexhull(Ray([1, 0]))"
    end
    @testset "H-Representation" begin
        @test replstr(h)        == "H-representation Polyhedra.Intersection{Rational{BigInt},Array{Rational{BigInt},1}}:\n3-element iterator of Polyhedra.HalfSpace{Rational{BigInt},Array{Rational{BigInt},1}}:\n HalfSpace(Rational{BigInt}[-1//2, -1//2], 0//1)\n HalfSpace(Rational{BigInt}[0//1, -1//4], 3//4)\n HalfSpace(Rational{BigInt}[0//1, 1//2], -1//2)"
        @test replstr(h, false) == "H-representation Polyhedra.Intersection{Rational{BigInt},Array{Rational{BigInt},1}}:\n3-element iterator of Polyhedra.HalfSpace{Rational{BigInt},Array{Rational{BigInt},1}}:\n HalfSpace(Rational{BigInt}[-1//2, -1//2], 0//1)\n HalfSpace(Rational{BigInt}[0//1, -1//4], 3//4)\n HalfSpace(Rational{BigInt}[0//1, 1//2], -1//2)"
    ...
    @testset "Polyhedron" begin
        @test replstr(p)        == "Polyhedron Polyhedra.SimplePolyhedron{Rational{BigInt},Polyhedra.Intersection{Rational{BigInt},Array{Rational{BigInt},1}},Polyhedra.Hull{Rational{BigInt},Array{Rational{BigInt},1}}}:\n3-element iterator of Polyhedra.HalfSpace{Rational{BigInt},Array{Rational{BigInt},1}}:\n HalfSpace(Rational{BigInt}[-1//2, -1//2], 0//1)\n HalfSpace(Rational{BigInt}[0//1, -1//4], 3//4)\n HalfSpace(Rational{BigInt}[0//1, 1//2], -1//2):\n3-element iterator of Array{Rational{BigInt},1}:\n Rational{BigInt}[1//1, -1//1]\n Rational{BigInt}[2//1, -2//1]\n Rational{BigInt}[3//1, -3//1],\n1-element iterator of Polyhedra.Ray{Rational{BigInt},Array{Rational{BigInt},1}}:\n Ray(Rational{BigInt}[1//1, 0//1])"
        @test replstr(p, false) == "Polyhedron Polyhedra.SimplePolyhedron{Rational{BigInt},Polyhedra.Intersection{Rational{BigInt},Array{Rational{BigInt},1}},Polyhedra.Hull{Rational{BigInt},Array{Rational{BigInt},1}}}:\n3-element iterator of Polyhedra.HalfSpace{Rational{BigInt},Array{Rational{BigInt},1}}:\n HalfSpace(Rational{BigInt}[-1//2, -1//2], 0//1)\n HalfSpace(Rational{BigInt}[0//1, -1//4], 3//4)\n HalfSpace(Rational{BigInt}[0//1, 1//2], -1//2):\n3-element iterator of Array{Rational{BigInt},1}:\n Rational{BigInt}[1//1, -1//1]\n Rational{BigInt}[2//1, -2//1]\n Rational{BigInt}[3//1, -3//1],\n1-element iterator of Polyhedra.Ray{Rational{BigInt},Array{Rational{BigInt},1}}:\n Ray(Rational{BigInt}[1//1, 0//1])"
        @test showstr(p) == "HalfSpace(Rational{BigInt}[-1//2, -1//2], 0//1) ∩ HalfSpace(Rational{BigInt}[0//1, -1//4], 3//4) ∩ HalfSpace(Rational{BigInt}[0//1, 1//2], -1//2) : convexhull(Rational{BigInt}[1//1, -1//1], Rational{BigInt}[2//1, -2//1], Rational{BigInt}[3//1, -3//1]) + convexhull(Ray(Rational{BigInt}[1//1, 0//1]))"
    end
    p = polyhedron(h)
