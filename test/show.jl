...
@testset "Show" begin
    ...
    @testset "Polyhedron without H-representation" begin
        @test replstr(p)        == "Polyhedron Polyhedra.SimplePolyhedron{2,Rational{BigInt},Polyhedra.Intersection{2,Rational{BigInt},Array{Rational{BigInt},1}},Polyhedra.Hull{2,Rational{BigInt},Array{Rational{BigInt},1}}}:\n3-element iterator of Array{Rational{BigInt},1}:\n Rational{BigInt}[1//1, -1//1]\n Rational{BigInt}[2//1, -2//1]\n Rational{BigInt}[3//1, -3//1],\n1-element iterator of Polyhedra.Ray{2,Rational{BigInt},Array{Rational{BigInt},1}}:\n Ray(Rational{BigInt}[1//1, 0//1])"
        @test replstr(p, false) == "Polyhedron Polyhedra.SimplePolyhedron{2,Rational{BigInt},Polyhedra.Intersection{2,Rational{BigInt},Array{Rational{BigInt},1}},Polyhedra.Hull{2,Rational{BigInt},Array{Rational{BigInt},1}}}:\n3-element iterator of Array{Rational{BigInt},1}:\n Rational{BigInt}[1//1, -1//1]\n Rational{BigInt}[2//1, -2//1]\n Rational{BigInt}[3//1, -3//1],\n1-element iterator of Polyhedra.Ray{2,Rational{BigInt},Array{Rational{BigInt},1}}:\n Ray(Rational{BigInt}[1//1, 0//1])"
